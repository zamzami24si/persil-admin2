                    ...
                    <form action="{{ route('sengketa-persil.store', $persil->persil_id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('pihak_1') is-invalid @enderror"
                                        id="pihak_1" name="pihak_1" value="{{ old('pihak_1') }}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('pihak_2') is-invalid @enderror"
                                        id="pihak_2" name="pihak_2" value="{{ old('pihak_2') }}"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('kronologi') is-invalid @enderror"
                                ...
                                placeholder="Jelaskan kronologi dan detail sengketa yang terjadi" required>{{ old('kronologi') }}</textarea>
                            @error('kronologi')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('penyelesaian') is-invalid @enderror"
                                        id="penyelesaian" name="penyelesaian" rows="3"
                                        placeholder="Jelaskan proses penyelesaian sengketa (jika sudah selesai)">{{ old('penyelesaian') }}</textarea>
                                    @error('penyelesaian')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <div class="file-upload-area">
                                        ...
                                        <div class="form-text">
                                            Upload file bukti sengketa (PDF, JPG, PNG, DOC). Maksimal 2MB per file.
                                        </div>
