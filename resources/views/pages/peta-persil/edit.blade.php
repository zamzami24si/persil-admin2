{{-- resources/views/pages/peta-persil/edit.blade.php --}}
                    ...
                    <form action="{{ route('peta-persil.update', $peta->peta_id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('panjang_m') is-invalid @enderror"
                                        id="panjang_m" name="panjang_m" value="{{ old('panjang_m', $peta->panjang_m) }}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('lebar_m') is-invalid @enderror"
                                        id="lebar_m" name="lebar_m" value="{{ old('lebar_m', $peta->lebar_m) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('geojson') is-invalid @enderror"
                                ...
                                placeholder='Masukkan data GeoJSON (contoh: {"type": "Feature", "geometry": {...}})'>{{ old('geojson', $peta->geojson ? json_encode($peta->geojson, JSON_PRETTY_PRINT) : '') }}</textarea>
                            <div class="form-text">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <label for="peta_files" class="form-label">Upload File Peta/Scan Baru</label>
                                    <div class="file-upload-area">
                                        <div class="dropzone border rounded p-5 text-center mb-3" id="petaFilesDropzone">
                                            <i class="fas fa-cloud-upload-alt fa-3x text-muted mb-3"></i>
                                            <h5>Drop file peta baru di sini</h5>
                                        ...
                                        <div class="form-text">
                                            Upload file peta atau scan baru (JPG, PNG, PDF, SVG). Maksimal 2MB per file.
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="card bg-light">
                                    <div class="card-body">
                                        ...
                                        <p class="mb-1"><strong>Kode:</strong> {{ $peta->persil->kode_persil }}</p>
                                        <p class="mb-1"><strong>Penilik:</strong> {{ $peta->persil->penilik->nama }}</p>
                                        <p class="mb-1"><strong>Luas:</strong> {{ number_format($peta->persil->luas_m2, 2) }} m²</p>
                                        <p class="mb-0"><strong>Alamat:</strong> {{ Str::limit($peta->persil->alamat_lahan, 50) }}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="card bg-info text-white">
                                    <div class="card-body">
                                        ...
                                        <p class="mb-1">Luas dari data persil: <strong>{{ number_format($peta->persil->luas_m2, 2) }} m²</strong></p>
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            <a href="{{ route('peta-persil.index') }}" class="btn btn-secondary">
                                <i class="fas fa-arrow-left"></i> Kembali ke Daftar Peta
                            </a>
                            <div>
                                <a href="{{ route('peta-persil.show', $peta->peta_id) }}" class="btn btn-info">
                                    <i class="fas fa-eye"></i> Lihat Detail
                                </a>
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save"></i> Update Peta
                                </button>
                            </div>
                        </div>
                    </form>
